...
M.base = {
    ...
    FloatBorder               = { fg = colors.black1, bg = "NONE" },
...
M.plugins = {
    ...
    NvimTreeFolderName                 = { fg = colors.blue_type },
    ...
    TelescopePromptTitle               = { fg = colors.line_fg, bg = colors.blue_type },
    TelescopeResultsTitle              = { fg = colors.line_fg, bg = colors.pink },
    ...
    ["@markup.list.unchecked"]              = { fg = colors.red_err },
    -----------------------------------------
